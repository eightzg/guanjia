...
@interface GuideVC () <EAIntroDelegate>
...
- (void)showIntroWithCrossDissolve {
    ...
    page1.title = @"just for Yi lab use";
//    page1.desc = @"Lorem ipsum dolor sit amet, consectetur adipisicingel it, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.";
    page1.bgImage = [UIImage imageNamed:@"1"];
//    page1.titleImage = [UIImage imageNamed:@"original"];
    
    EAIntroPage *page2 = [EAIntroPage page];
    page2.title = @"made by eight";
...
//    self.view.window.rootViewController = nav;    //这种方式可能获取不到window采用下面的方法
